...
import { useUpdateColumn, useDeleteColumn, type Column as ColumnType } from './use-columns';
...
export function Column({ column, onDeleted }: ColumnProps) {
  return (
    <div className="flex h-full w-80 shrink-0 flex-col rounded-lg border bg-card">
      <ColumnHeader column={column} onDeleted={onDeleted} />
...
function ColumnHeader({ column, onDeleted }: ColumnHeaderProps) {
